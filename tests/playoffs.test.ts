...
describe('a one-wild-card race', () => {
  ...
  it('measures a division leader\'s cushion against its nearest rival, never the club at the bottom of the division', () => {
    // 60-40 against 55-45 is five games; the 50-50 club is ten back and is not the one that would take the place
    expect(playoffPicture(leaderA)!.cushion).toBe(5);
    // 58-42 against 55-46 is three and a half

...
function evaluateActivateFromIl(ctx: RightsContext): ActionRights {
  ...
  return result(a, 'indeterminate', sixty ? '60-day IL — activation not established' : 'IL activation not established', {
    reasons: [reason(
      ...
      sixty
        ? 'He is on the 60-day list and off the 40-man. Whether activation needs a 40-man spot, and what OOTP does when there is none, has not been observed.'
        : 'He is on the injured list and still on the 40-man. OOTP\'s minimum stay and whether an injured player can be activated have not been observed.',
      'export_state', 'players_roster_status.is_on_dl60'
    )],
    missing: [{ code: 'rule_not_established', message: 'Activation from an injured list has not been observed.' }],
    facts: {
      injuryDaysLeft: s.injury.daysLeft.value,
